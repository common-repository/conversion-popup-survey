 ...
 *
 */
$pops_id = isset($_GET['id']) ? $_GET['id'] : '0';

$sql = $wpdb->prepare("
	SELECT COUNT(*) AS `count` FROM ".POPS_TABLE."
	WHERE `id` = %d
	",
	array($pops_id)
);
...
<div class="wrap">
	...
	<div class="error"><p><strong>Oops, selected survey doesn&#39;t exist.</strong> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=pops_manage">Click here</a> to go back to the overview page.</p></div>
</div>
<?php
}
else
{
	...
	$pops_info = array();
	$pops_info = $wpdb->get_row($sql, ARRAY_A);

	$pops_info_un = unserialize($pops_info['content_data']);
	 ...
	 */
	$form = array(
		'pops_survey_name' => $pops_info['name'],
		'pops_survey_active' => $pops_info['active'],
		'pops_survey_reoccurances' => $pops_info_un['pops_survey_reoccurances'],
		'pops_survey_reoccurances_days' => $pops_info_un['pops_survey_reoccurances_days'],
		'pops_survey_cookie_name' => $pops_info_un['pops_survey_cookie_name'],
		'pops_show_on_pages' => $pops_info_un['pops_show_on_pages'],
		'pops_show_on_posts' => $pops_info_un['pops_show_on_posts'],
		'pops_survey_delay' => $pops_info_un['pops_survey_delay'],

		'pops_survey_header_title' => $pops_info_un['pops_survey_header_title'],
		'pops_survey_open_text' => $pops_info_un['pops_survey_open_text'],
		'pops_survey_entry' => $pops_info_un['pops_survey_entry'],
		'pops_survey_button_text' => $pops_info_un['pops_survey_button_text'],

		'pops_general_width' => $pops_info_un['pops_general_width'],
		'pops_general_height' => $pops_info_un['pops_general_height'],
		'pops_general_location' => $pops_info_un['pops_general_location'],
		'pops_general_margin_tb' => $pops_info_un['pops_general_margin_tb'],
		'pops_general_margin_lr' => $pops_info_un['pops_general_margin_lr'],

		'pops_header_background_color' => $pops_info_un['pops_header_background_color'],
		'pops_header_font_face' => $pops_info_un['pops_header_font_face'],
		'pops_header_font_color' => $pops_info_un['pops_header_font_color'],
		'pops_header_font_size' => $pops_info_un['pops_header_font_size'],
		'pops_header_padding' => $pops_info_un['pops_header_padding'],

		'pops_content_background_color' => $pops_info_un['pops_content_background_color'],
		'pops_content_font_face' => $pops_info_un['pops_content_font_face'],
		'pops_content_font_color' => $pops_info_un['pops_content_font_color'],
		'pops_content_font_size' => $pops_info_un['pops_content_font_size'],
		'pops_content_padding' => $pops_info_un['pops_content_padding'],

		'pops_border_style' => $pops_info_un['pops_border_style'],
		'pops_border_color' => $pops_info_un['pops_border_color'],
		'pops_border_width' => $pops_info_un['pops_border_width'],
		'pops_border_padding' => $pops_info_un['pops_border_padding'],
		'pops_border_background_color' => $pops_info_un['pops_border_background_color']
	);
	...
	if (isset($_POST['form_submit']) && $_POST['form_submit'] == 'yes')
	{
		...
		check_admin_referer('pops_edit_survey');
		...
		if ($pops_error_found == FALSE)
		{
			$sql = $wpdb->prepare("
				...
				LIMIT 1
				",
				array($form['pops_survey_name'], serialize($form), $form['pops_show_on_pages'], $form['pops_show_on_posts'], $form['pops_survey_active'], $pops_info['id'])
			);
			$wpdb->query($sql);

			$pops_success = 'Survey successfully updated.';
		}
	}
?>
<div class="wrap">
...
?>
	...
	<form method="post" action="<?php echo get_option('siteurl'); ?>/wp-admin/admin.php?page=pops_manage&amp;sp=edit&amp;id=<?php echo $pops_info['id']; ?>">
		<div>
			...
			<?php wp_nonce_field('pops_edit_survey'); ?>
		</div>
...
?>
	    ...
	    <p class="submit"><input type="button" class="button-secondary" id="pops_preview_design" value="Preview Survey" /> <input type="submit" class="button-primary" value="Update Survey" /></p>
	</form>
</div>
